...
router.post('/deleteOrder', auth, requireOrganization, requireOrgRole('manager', 'owner'), deleteOrder)
router.get('/customers/:customerId/orders', auth, requireOrganization, getCustomerOrderHistory)

// Statistics & Charts
router.get('/statistics', auth, requireOrganization, getStatistics)
router.get('/income/chart/monthly', auth, requireOrganization, getMonthlyIncomeChart)
router.get('/income/chart/last-7-days', auth, requireOrganization, getLast7DaysIncome)
router.get('/income/chart/range', auth, requireOrganization, getIncomeByDateRange)
